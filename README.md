...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/zfit-physics-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8102&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/zfit-physics-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `zfit-physics` can be installed with:

```
conda install zfit-physics
```

It is possible to list all of the versions of `zfit-physics` available on your platform with:
